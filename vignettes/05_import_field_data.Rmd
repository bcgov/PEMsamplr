...
st_write(processed_transects,  file.path(cleandat, "proc_s1_transects_ryan.gpkg"), 
         delete_layer = TRUE)

sf::st_write(points, file.path(cleandat, "s1_points_ryan.gpkg"), delete_layer = TRUE)
