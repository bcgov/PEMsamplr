...
st_write(processed_transects,  file.path(cleandat, "proc_s1_transects_b2019bcgov.gpkg"), 
         delete_layer = TRUE)

sf::st_write(points, file.path(cleandat, "s1_points_b2019bcgov.gpkg"), delete_layer = TRUE)
