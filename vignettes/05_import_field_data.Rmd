...
st_write(processed_transects,  file.path(cleandat, "proc_s1_transects_williamslake.gpkg"), 
         delete_layer = TRUE)

sf::st_write(points, file.path(cleandat, "s1_points_williamslake.gpkg"), delete_layer = TRUE)
...
sf::st_write(tracks, file.path(cleandat, "s1_tracklog_williamslake.gpkg"), delete_layer = TRUE)
