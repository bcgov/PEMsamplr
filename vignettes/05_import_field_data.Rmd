...
# 
 inpath <- "D:\\PEM_DATA\\BEC_DevExchange_Work\\OldFort_AOI\\2_sample_design\\stage1_StudyDesign\\transect_layout"
# 
...
```{r}
# 
 rawdat <- "D:\\PEM_DATA\\BEC_DevExchange_Work\\OldFort_AOI\\2_sample_design\\stage1_StudyDesign\\transect_data"
# 
# rawdat <- "D:\\PEM_DATA\\BEC_DevExchange_Work\\WilliamsLake_AOI\\2_sample_design\\stage1_StudyDesign\\transect_data"

#rawdat <- "D:\\PEM_DATA\\BEC_DevExchange_Work\\KootInvCran_AOI\\2_sample_design\\stage1_StudyDesign\\transect_data\\final_contractors\\_danielle\\"
...
st_write(processed_transects,  file.path(cleandat, "proc_s1_transects_oldfort.gpkg"), 
         delete_layer = TRUE)

sf::st_write(points, file.path(cleandat, "s1_points_oldfort.gpkg"), delete_layer = TRUE)
...
sf::st_write(tracks, file.path(cleandat, "s1_tracklog_oldfort.gpkg"), delete_layer = TRUE)
