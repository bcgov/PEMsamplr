...
rawdat <- "D:\\PEM_DATA\\BEC_DevExchange_Work\\KootInvCran_AOI\\2_sample_design\\stage1_StudyDesign\\transect_data\\final_contractors\\_ran\\"
...
st_write(processed_transects,  file.path(cleandat, "proc_s1_transects_ran.gpkg"), 
         delete_layer = TRUE)

sf::st_write(points, file.path(cleandat, "s1_points_ran.gpkg"), delete_layer = TRUE)
