...
rawdat <- "D:\\PEM_DATA\\BEC_DevExchange_Work\\KootInvCran_AOI\\2_sample_design\\stage1_StudyDesign\\transect_data\\final_contractors\\_ben\\"
...
st_write(processed_transects,  file.path(cleandat, "proc_s1_transects_ben.gpkg"), 
         delete_layer = TRUE)

sf::st_write(points, file.path(cleandat, "s1_points_ben.gpkg"), delete_layer = TRUE)
